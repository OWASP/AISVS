...
- [C05 Access Control](../C05-Access-Control/C05-Access-Control.md) -- the broader IAM context for agent identity, including multi-tenant isolation and autonomous agent authorization as first-class principals.
- [C11-07 Security Policy Adaptation](../C11-Adversarial-Robustness/C11-07-Security-Policy-Adaptation.md) -- runtime policy enforcement and audit trails for policy changes, connecting to 9.4.5's requirement for policy version tracking in audit records.
