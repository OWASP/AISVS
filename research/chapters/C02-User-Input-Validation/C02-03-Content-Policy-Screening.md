...
| [C09 Orchestration & Agentic Action](C09-Orchestration-and-Agents) | Rejected content must not propagate through agent chains (2.3.2) |
| [C10 MCP Security](C10-MCP-Security) | Content screening must cover MCP tool inputs/outputs; policy-violating content must not propagate to MCP servers (2.3.2) |
| [C13 Monitoring & Logging](C13-Monitoring-and-Logging) | Screening logs (2.3.3) feed into the broader monitoring and SIEM infrastructure |
