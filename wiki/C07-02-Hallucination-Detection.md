...
**Legal crisis scale:** 1,213 documented cases as of late March 2026 (up from 1,092 two weeks prior); 1,012 instances of fabricated case law, with pro se litigants (719) and practicing lawyers (463) as primary offenders. Five-figure sanctions are now routine, with cumulative penalties exceeding $100,000 in some individual cases. Stanford: LLMs hallucinate 75%+ of the time on legal questions about court rulings. 79% of lawyers now use AI tools in practice (ABA TechReport 2025), amplifying hallucination exposure. The OWASP AI Testing Guide 2026 formally includes hallucination testing as a core test category alongside prompt injection and toxic output. BriefCatch launched RealityCheck at Legalweek (March 2026) — the first purpose-built legal citation verification tool combining deterministic database checks with AI-assisted content validation.
