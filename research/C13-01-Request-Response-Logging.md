...
| **13.1.2** | **Verify that** logs are stored in secure, access-controlled repositories with appropriate retention policies and backup procedures. | 1 | Unauthorized access to AI interaction logs; loss of forensic evidence due to inadequate retention; log tampering or deletion by attackers covering tracks. The EU AI Act Article 12 mandates automatic logging with traceability for high-risk AI systems (enforcement August 2, 2026, with a possible Digital Omnibus delay under discussion that could shift the deadline to December 2027). | Review access control policies on log storage (IAM, RBAC). Confirm retention policy documentation and automated enforcement -- the EU AI Act requires at least six months of log retention for high-risk systems. Verify backup procedures and test restoration. Cross-check that RBAC roles separate log-writer, log-reader, and log-admin privileges. Confirm that logs are generated by the system itself (Article 12's "technically" and "automatic" clauses), not through a manual export step. | Retention periods must balance forensic needs with privacy regulations (GDPR data minimization vs. EU AI Act six-month minimum). AI logs may contain more sensitive context than traditional application logs. Non-compliance with Article 12's record-keeping obligations specifically carries fines up to EUR 15M or 3% of global turnover (Article 99); the higher EUR 35M / 7% penalty tier applies only to prohibited AI practices. Two draft harmonized standards are in development to give concrete guidance -- **prEN 18229-1** ("AI trustworthiness framework -- Part 1: Logging, transparency and human oversight") and **ISO/IEC DIS 24970** (AI system logging) -- but neither was finalized as of April 2026. |
...
As of April 2026, the EU AI Act's high-risk requirements (Articles 9-49) are scheduled to become enforceable on **August 2, 2026**, although an EU Digital Omnibus package currently under discussion could push that deadline out to December 2027 for some obligations. Article 12 requires that high-risk AI systems support automatic recording of events ("logs") throughout their lifecycle, with a level of traceability appropriate to the system's intended purpose. Key specifics:
...
This incident has direct implications for requirements 13.1.2 (secure log storage) and 13.1.3 (encryption in transit):
...
- **EU AI Act Article 12** -- Record-keeping requirements for high-risk AI systems, enforcement August 2, 2026 (pending possible Digital Omnibus delay) ([ai-act-service-desk.ec.europa.eu](https://ai-act-service-desk.ec.europa.eu/en/ai-act/article-12), practical walkthrough at [helpnetsecurity.com/2026/04/16/eu-ai-act-logging-requirements](https://www.helpnetsecurity.com/2026/04/16/eu-ai-act-logging-requirements/))
...
- [C7.6 Monitoring Integration](C07-06-Monitoring-Integration) -- Complements 13.1 with safety-violation metrics, rate-based alerting, and model-version-tagged audit trails emitted from the model behavior layer
