...
> **Requirements:** 5 | **IDs:** 10.6.1–10.6.5
...
| **10.6.5** | **Verify that** the client or orchestration layer maintains an authoritative tool namespace mapping that detects tool name collisions and prevents a lower-trust or newly registered server from shadowing tool definitions from a higher-trust server. | 3 | Pending research | Pending research | Pending research |
