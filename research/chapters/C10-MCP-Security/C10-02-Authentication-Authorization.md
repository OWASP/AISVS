...
> **Requirements:** 9 | **IDs:** 10.2.1–10.2.9
...
- **[C05-01 Identity Management & Authentication](../C05-Access-Control/C05-01-Identity-Management-Authentication.md)** — Foundational identity infrastructure that MCP auth builds on: centralized identity, MFA, and federated agent authentication
- **[C09-06 Authorization & Delegation](../C09-Orchestration-and-Agents/C09-06-Authorization-and-Delegation.md)** — Scoped capability tokens and per-action policy evaluation for agents — the authorization layer that complements MCP's OAuth transport
- **[C09-03 Tool & Plugin Isolation](../C09-Orchestration-and-Agents/C09-03-Tool-and-Plugin-Isolation.md)** — Sandbox isolation for agent tools overlaps with MCP auth: tool manifests, MCP supply chain attacks, and tiered isolation that complements auth controls
- **[C09-06 Authorization & Delegation](../C09-Orchestration-and-Agents/C09-06-Authorization-and-Delegation.md)** — Multi-agent delegation chains, credential isolation, and inter-agent peer authorization patterns referenced by RFC 8693 and Okta XAA
