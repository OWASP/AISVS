...
- [C06-01-Pretrained-Model-Vetting](../C06-Supply-Chain/C06-01-Pretrained-Model-Vetting.md) -- upstream counterpart: how third-party pretrained models are vetted (signing, scanning, AI-BOM provenance, adversarial evaluation) before they enter the registries and deployment pipelines this chapter governs.
- [C06-02-Trusted-Source-Enforcement](../C06-Supply-Chain/C06-02-Trusted-Source-Enforcement.md) -- policy layer for approved sources and publisher key pinning that underlies the signing and admission controls referenced in C3.1.
- [C06-04-Supply-Chain-Attack-Monitoring](../C06-Supply-Chain/C06-04-Supply-Chain-Attack-Monitoring.md) -- operational response side: AI-specific incident response playbooks, signature revocation, and downstream re-evaluation when lifecycle-stage compromises like TeamPCP/LiteLLM occur.
- [C01-05-Data-Lineage-Traceability](../C01-Training-Data/C01-05-Data-Lineage-Traceability.md) -- training-data lineage and provenance (OpenLineage, C2PA, OMS signing) that feeds the trace records required by C3.1 and is referenced by C3.4's training-data integrity expectations.
