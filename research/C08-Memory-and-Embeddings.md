...
- [C05-06 Multi-Tenant Isolation](C05-06-Multi-Tenant-Isolation.md) — cross-chapter counterpart for multi-tenant isolation covering network default-deny, tenant identity, namespace segregation, CMK encryption, and KV-cache partitioning.
