...
**Legal crisis scale (May 19, 2026 update):** **1,456 documented cases globally on the Charlotin counter as of 2026-05-18** (1,005 US, 451 non-US; up from ~1,300 in mid-May, 1,227 in early April, and 1,213 in late March), tracking roughly 5+ new cases per day. **865 cases involve pro se litigants and 555 involve lawyers**; fabricated case law remains the dominant failure mode. Non-US growth is led by Canada (152), Australia (74), UK (56), and Israel (52). Solo practitioners and firms under 25 attorneys still account for ~90% of lawyer-side cases, but the Sullivan & Cromwell incident (Apr 2026) confirms BigLaw is exposed too — including firms that advise AI vendors directly — and an early-May India Supreme Court matter logged in the database shows the bench is no longer immune. Q1 2026 sanctions totaled at least **$145,000** across publicly tracked cases. Six-figure sanctions are now routine — the **$110,000 Brigandi/Murphy order** in D. Or. (publicized April 2026) remains the working ceiling for two-attorney AI-citation conduct cases. Fortune's May 16, 2026 cover treatment ("Would you hire the lawyer who just got sanctioned for using AI?") moved the crisis into mainstream business coverage. Stanford: LLMs hallucinate 75%+ of the time on legal questions about court rulings. 79% of lawyers now use AI tools in practice (ABA TechReport 2025), amplifying hallucination exposure. The OWASP AI Testing Guide 2026 formally includes hallucination testing as a core test category alongside prompt injection and toxic output. BriefCatch launched RealityCheck at Legalweek (March 2026) — the first purpose-built legal citation verification tool combining deterministic database checks with AI-assisted content validation. Florida judicial circuits now require AI disclosure and independent citation verification for court filings. Manhattan's privilege-waiver ruling (Apr 2026) signals that hallucination-prone consumer AI is now also a litigation-privilege risk, not just a sanctions risk.

**EU AI Act update (May 2026):** On May 7, 2026, the Council and Parliament reached political agreement on amendments that clarify and partially extend high-risk-system compliance deadlines. The August 2, 2026 transparency obligations (chatbot disclosure, AI-content labeling, deepfake identification under Article 50) and accuracy/robustness/cybersecurity obligations for high-risk systems under Article 15 remain enforceable from August 2026 even where downstream high-risk deadlines slip, with AI-content labeling deferred only to December 2, 2026 in the amendment package. On **May 8, 2026** the European Commission published draft **Article 50 transparency guidelines**, open for stakeholder consultation until **June 3, 2026** and intended to apply alongside Article 50 from August 2, 2026; the same week, the third revision of the **Code of Practice on Marking and Labelling of AI-Generated Content** moved toward a final May-June 2026 release (first draft 2025-12-17, second 2026-03-03, third 2026-05-08). The Code does not impose accuracy or hallucination-disclosure obligations directly — it covers machine-readable content marking and deepfake/public-interest text disclosure — but provider-side compliance work overlaps materially with the logging, watermarking, and audit-trail controls that hallucination programs already need. Hallucination-prone high-risk systems should plan to evidence accuracy thresholds, post-market monitoring, and fallback behavior by the August 2026 milestone regardless.
...
- [European Commission — Code of Practice on marking and labelling of AI-generated content](https://digital-strategy.ec.europa.eu/en/policies/code-practice-ai-generated-content) — third draft published May 8, 2026; final release expected May-June 2026 ahead of Article 50 application on August 2, 2026
