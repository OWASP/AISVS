...
| **13.6.2** | **Verify that** autonomous initiative triggers include security context evaluation covering the agent's current authorization scope and the action classification per the human oversight policy (C14.2.1). | 2 |
