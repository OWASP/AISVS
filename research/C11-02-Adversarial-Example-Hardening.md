...
- **RobustBench** provides standardized adversarial robustness benchmarks using AutoAttack (an ensemble of white-box and black-box attacks) across CIFAR-10, CIFAR-100, and ImageNet. The leaderboard tracks 120+ models and serves as the de facto standard for comparing Lp-norm robustness claims. For requirement 11.2.4, RobustBench's AutoAttack ensemble provides a baseline "minimum bar" for adaptive evaluation -- any claimed defense that has not been tested against AutoAttack should be viewed with skepticism.

The OWASP AI Exchange testing guidance recommends a three-pronged approach to AI security testing: conventional security testing, model performance validation, and AI-specific red teaming. This mirrors the layered evaluation strategy implied by requirements 11.2.1 (known attacks), 11.2.3 (hardening), and 11.2.4 (adaptive attacks).
