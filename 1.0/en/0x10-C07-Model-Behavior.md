...
| **7.6.4** | **Verify that** RAG responses in which unsupported claims are detected are blocked or have the unsupported claims redacted before the response is served to the user. | 3 |
